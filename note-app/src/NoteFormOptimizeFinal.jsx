...
export default function NoteFormOptimizeFinal(props) {
        ...
        <form className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select
                id="category"
                name="category"
                className="w-full px-3 py-2 bg-white border-2 border-blue-200 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-teal-300 focus:border-teal-400 text-gray-700" onChange={handleChangeValue}
                value={data.category}
              >
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-3 py-2 bg-white border-2 border-blue-200 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-teal-300 focus:border-teal-400 text-gray-700 placeholder-gray-400 resize-none" onChange={handleChangeValue}
